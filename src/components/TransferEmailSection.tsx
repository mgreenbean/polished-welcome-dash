        ...
        <CardContent className="p-6">
          <div className="flex items-start space-x-4 mb-5">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-slate-800 mb-2">Your Transfer Email</h2>
          ...
          <div className="mb-5">
            ...
            <div className="flex space-x-3">
              ...
              <Button 
                variant="outline" 
                className="border-slate-300 text-slate-700 hover:bg-slate-100 px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-200 font-medium"
              >
                Copy
              </Button>
            </div>
