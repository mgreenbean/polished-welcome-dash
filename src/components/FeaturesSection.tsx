...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-16 sm:py-20 bg-gradient-to-br from-white via-blue-50 to-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 animate-fade-in">
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-900 mb-4 sm:mb-6">Why Choose SellMySeats?</h2>
          ...
          {features.map((feature, index) => (
            <Card key={index} className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 animate-scale-in border-blue-100 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-blue-900 mb-3">{feature.title}</h3>
